...
#define PIN_DAP_LED_BIT                 9
#define PIN_DAP_LED                     (1 << PIN_DAP_LED_BIT)
#define PIN_DAP_LED_IOCON               LPC_IOCON->PIO0_9
...
#define PIN_MSD_LED_IOCON               LPC_IOCON->PIO0_8
...
#define PIN_TDO_IOCON                   LPC_IOCON->PIO0_23
